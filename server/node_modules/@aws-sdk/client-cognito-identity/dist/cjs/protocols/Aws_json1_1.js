...
const deserializeAws_json1_1CognitoIdentityProvider = (output, context) => {
    return {
        ...
        ServerSideTokenCheck: smithy_client_1.expectBoolean(output.ServerSideTokenCheck),
    };
};
...
const deserializeAws_json1_1Credentials = (output, context) => {
    return {
        ...
        Expiration: output.Expiration !== undefined && output.Expiration !== null
            ...
            : undefined,
        SecretKey: smithy_client_1.expectString(output.SecretKey),
...
const deserializeAws_json1_1GetPrincipalTagAttributeMapResponse = (output, context) => {
    return {
        ...
        PrincipalTags: output.PrincipalTags !== undefined && output.PrincipalTags !== null
            ...
            : undefined,
        UseDefaults: smithy_client_1.expectBoolean(output.UseDefaults),
    };
};
...
const deserializeAws_json1_1IdentityPool = (output, context) => {
    return {
        AllowClassicFlow: smithy_client_1.expectBoolean(output.AllowClassicFlow),
        AllowUnauthenticatedIdentities: smithy_client_1.expectBoolean(output.AllowUnauthenticatedIdentities),
        CognitoIdentityProviders: output.CognitoIdentityProviders !== undefined && output.CognitoIdentityProviders !== null
            ...
            : undefined,
        DeveloperProviderName: smithy_client_1.expectString(output.DeveloperProviderName),
        IdentityPoolId: smithy_client_1.expectString(output.IdentityPoolId),
...
const deserializeAws_json1_1MappingRule = (output, context) => {
    return {
        Claim: smithy_client_1.expectString(output.Claim),
        MatchType: smithy_client_1.expectString(output.MatchType),
...
const deserializeAws_json1_1RoleMapping = (output, context) => {
    return {
        AmbiguousRoleResolution: smithy_client_1.expectString(output.AmbiguousRoleResolution),
